...
var infoStream = fs.createWriteStream(`${__dirname}/../../../logs/info.log`);
...
// file if needed.
var errorStream = fs.createWriteStream(`${__dirname}/../../../logs/error.log`);
...
var debugStream = fs.createWriteStream(`${__dirname}/../../../logs/debug.log`);
